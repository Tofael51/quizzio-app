...
import 'package:quizzio/pages/create_quiz/writeans.dart';
...
class _CreateQuestion3State extends State<CreateQuestion3> {
 ...
 late FocusNode text1, text2, text3, text4;
          ...
          complete: () {
            ...
            Container(
              ...
              fontWeight: FontWeight.w600,
                  ...
                  labelText: 'Add Questions (Pre-Sentence)',
                  hintText: 'We cannot solve our problems with the same',
                  isRequired: true,
                   suffixIcon: Align(
              widthFactor:1,
              heightFactor:1,
  ...
  SizedBox(height: 16,),
                   ...
                   CustomTextField(
                  controller: _addqsnController,
                  labelText: 'Add Questions (Post-Sentence)',
                  hintText: 'We cannot solve our problems with the same',
                  isRequired: true,
                   suffixIcon: Align(
              widthFactor:1,
